  ...
  class RetaggingsCount
    def up
      ...
      begin
        ...
        puts "✓ Successfully recounted all taggings in #{(Time.current - start_time).round(2)}s"
      rescue => e
    ...
    def down
      ...
      puts "This data update cannot be reversed. Counts have been corrected based on actual taggings."
    end
  end
end

DataUpdateScripts::RetaggingsCount.new.up
